...
[TestFixture]
internal sealed class PeripheralDisconnectedFromDeviceTests
{
    [Test]
    public void PeripheralConnectedToDeviceEvent_Tests()
    {
        ...
        var testEvent = new PeripheralDisconnectedFromDeviceEvent(deviceId, devId, peripheralName, manufacturer);
