...
public sealed class GroupPolicySetting
{
    ...
    /// <summary>
    /// Gets or sets the Merge Type of the Group Policy Setting.
    /// </summary>
    public GroupPolicySettingMergeType? MergeType { get; set; }

    /// <summary>
    /// Gets or sets the Sub Key Name of the Group Policy Setting.
    /// </summary>
    public string SubKey { get; set; }

    /// <summary>
    /// Gets or sets the Key Type of the Group Policy Setting.
    /// </summary>
